...
axes[0].plot(df['T'], df['regret_gr_desc'], '-', c='tab:blue', label='Algorithm 1')
axes[0].plot(df['T'], df['regret_stochastic'], '*-', c='tab:orange', label='User mean VoT')
axes[0].plot(df['T'], df['regret_no_vot'], 'o-', c='tab:green', label='Population mean VoT')
axes[0].plot(df['T'], df['regret_const_update'], 'D-', c='tab:red', label='Reactive update')
axes[0].set_xlabel('Time Periods')
axes[0].set_ylabel('Average Normalized Regret')
axes[0].legend(loc="lower right")
...
axes[1].plot(df['T'], df['vio_gr_desc'], '-', c='tab:blue', label='Algorithm 1')
axes[1].plot(df['T'], df['vio_stochastic'], '*-', c='tab:orange', label='User mean VoT')
axes[1].plot(df['T'], df['vio_no_vot'], 'o-', c='tab:green', label='Population mean VoT')
axes[1].plot(df['T'], df['vio_const_update'], 'D-', c='tab:red', label='Reactive update')
axes[1].set_xlabel('Time Periods')
axes[1].set_ylabel('Average Normalized Capacity Violation')
# axes[1].legend(loc="upper right")
...
axes[2].plot(df['T'], 1 + df['ttt_no_vot'], 'o-', c='tab:green', label='Population mean VoT')
axes[2].plot(df['T'], 1 + df['ttt_const_update'], 'D-', c='tab:red', label='Reactive update')
