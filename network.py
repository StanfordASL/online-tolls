...
class Network:
    ...
    def __init__(self, city):
        ...
        # save capacity and latency for making plots later
        vector_to_file('Results/capacity.csv', self.capacity_list())
        vector_to_file('Results/latency.csv', self.latency_list())
